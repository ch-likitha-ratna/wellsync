...
ALTER TABLE tickets ADD COLUMN IF NOT EXISTS subject VARCHAR(255) DEFAULT 'Support Request';

-- Insert sample data for anonymous feedback
INSERT IGNORE INTO anonymous_feedback (employee_id, feedback_type, target_role, feedback_text) VALUES
...
INSERT IGNORE INTO notifications (employee_id, title, message, type) VALUES
...
INSERT IGNORE INTO device_inventory (device_type, brand, model, serial_number, assigned_to, status) VALUES
...
INSERT IGNORE INTO user_activity_log (employee_id, action, details) VALUES
(24, 'Login', 'User logged in successfully'),
(25, 'Leave Request Submitted', 'Leave request for vacation'),
(26, 'Timesheet Submitted', 'Weekly timesheet submission'),
(27, 'Course Completed', 'Completed Python Programming course'),
(28, 'Ticket Submitted', 'IT support ticket for laptop issue');